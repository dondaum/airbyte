...
import pytest
from source_icecat.source import IcecatStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(IcecatStream, "path", "v0/example_endpoint")
    mocker.patch.object(IcecatStream, "primary_key", "test_primary_key")
    mocker.patch.object(IcecatStream, "__abstractmethods__", set())
